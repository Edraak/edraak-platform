...
FEATURES = {
    ...
    # Enable Logistration
    'ENABLE_EDRAAK_LOGISTRATION': True,
...
SESSION_SERIALIZER = 'openedx.core.lib.session_serializers.JSONSessionSerializer'
...
COUNTRIES_OVERRIDE = {
    ...
    # "TW": "Taiwan",   # Edraak (countries): We are not overriding Taiwan anymore, because we want it to be translated
    'XK': _('Kosovo'),
